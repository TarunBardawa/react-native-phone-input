    ...
    render(){
        ...
        return (
            <View style={[styles.container, this.props.style]}>
                ...
                {this.props.isDownArrow && <Image source={this.props.downArrow} style={[styles.downArrow, this.props.downArrowStyle]} resizeMode={'contain'}/>}
                <View style={{flex:1}}>
					<TextComponent
						ref='inputPhone'
						autoCorrect={false}
...
PhoneInput.propTypes = {
  ...
  downArrowStyle:PropTypes.oneOfType([PropTypes.object, PropTypes.number]),
  isDownArrow:PropTypes.bool,
	
}

PhoneInput.defaultProps = {
    downArrow:require('./resources/downArrow/default.png'),
